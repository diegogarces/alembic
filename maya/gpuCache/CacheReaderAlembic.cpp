    ...
    Pivots::Ptr& pivots)
{
    ...
    Alembic::Abc::IObject current;
    SubNode::Ptr top = readHierarchyInternal(geomPath, needUVs, current, pivots);
...
SubNode::Ptr AlembicCacheReader::readHierarchyInternal(const MString& geomPath, bool needUVs, Alembic::Abc::IObject& current, Pivots::Ptr& pivots)
{
...
SubNode::Ptr AlembicCacheReader::readHierarchy(
    const MString& geomPath, bool needUVs, Pivots::Ptr& pivots)
{
    Alembic::Abc::IObject current;
    return readHierarchyInternal(geomPath, needUVs, current, pivots);
}
...
Pivots::Ptr AlembicCacheReader::readPivots(Alembic::Abc::IObject current)
{
    if (!valid()) return Pivots::Ptr();
