...
MStatus Command::doIt(const MArgList& args)
{
    ...
    fSaveMultipleFilesFlag.parse(argsDb, "-saveMultipleFiles");
    ...
    fClashOptionFlag.parse(argsDb, "-clashOption");
	...
	fUVsFlag.parse(argsDb, "-writeUVs");
    ...
    fUseBaseTessellationFlag.parse(argsDb, "-useBaseTessellation");
    ...
    fPromptFlag.parse(argsDb, "-prompt");
