...
private:
    ...
    SubNode::Ptr readHierarchyInternal(
        const MString& geomPath, bool needUVs, Alembic::Abc::IObject& current, Pivots::Ptr& pivots);

    virtual Pivots::Ptr readPivots(Alembic::Abc::IObject current);
};
